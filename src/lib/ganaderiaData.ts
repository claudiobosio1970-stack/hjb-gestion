...
export const CORRALES_DEFINICION_DEFAULT: DefinicionCorral[] = [
  {
    id: "guachera",
    numero: 1,
    nombreCorto: "Guachera / Estaca",
    nombreCompleto: "1- Guachera / Estaca hasta 80kg",
    icono: "🍼",
    pesoEntradaKg: 38,
    pesoObjetivoKg: 80,
    diasEstimados: 60,
  ...
  },
  {
    id: "rm1",
    numero: 2,
    nombreCorto: "Recría Mixta 1",
    nombreCompleto: "2- RM1 - Recría Mixta 1 hasta 115kg",
    icono: "🥣",
    pesoEntradaKg: 80,
    pesoObjetivoKg: 115,
    diasEstimados: 30,
    diasAcumulados: 90,
    color: "#06b6d4",
    descripcion: "Adaptación post-desleche a ración sólida y desarrollo ruminal temprano.",
    dietaBase: [
  ...
  },
  {
    id: "rm2",
    numero: 3,
    nombreCorto: "Recría Mixta 2",
    nombreCompleto: "3- RM2 - Recría Mixta 2 hasta 170kg",
    icono: "🌽",
    pesoEntradaKg: 115,
    pesoObjetivoKg: 170,
    diasEstimados: 60,
    diasAcumulados: 150,
    color: "#eab308",
    descripcion: "Crecimiento estructural y óseo a corral con ración energética y proteica.",
    dietaBase: [
  ...
  },
  {
    id: "rm3",
    numero: 4,
    nombreCorto: "Recría Mixta 3",
    nombreCompleto: "4- RM3 - Recría Mixta 3 hasta 270kg",
    icono: "🌿",
    pesoEntradaKg: 170,
    pesoObjetivoKg: 270,
    diasEstimados: 120,
    diasAcumulados: 270,
    color: "#10b981",
    descripcion: "Desarrollo muscular con inclusión de silaje de maíz y preparación para engorde.",
    dietaBase: [
  ...
  },
  {
    id: "terminacion",
    numero: 5,
    nombreCorto: "Cría Gordos (Terminación)",
    nombreCompleto: "5- CG - Cría Gordos hasta 400kg",
    icono: "🥩",
    pesoEntradaKg: 270,
    pesoObjetivoKg: 410,
    diasEstimados: 90,
    diasAcumulados: 360,
    color: "#f97316",
    descripcion: "Terminación intensiva a corral para lograr terminación comercial y grasa adecuada.",
    dietaBase: [
